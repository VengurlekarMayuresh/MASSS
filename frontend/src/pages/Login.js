      ...
      <div className={`container ${isSignUp ? 'right-panel-active' : ''}`} id="container">
          ...
          <form className="multi-step-form" onSubmit={handleSignUpSubmit}>
            <div className={`form-step ${currentStep === 1 ? 'active' : ''}`}>
              ...
              <div className={`input-group ${errors.phone ? 'invalid' : ''}`}>
                ...
                <input type="tel" name="phone" placeholder="Phone Number" value={signUpData.phone} onChange={handleSignUpChange} />
                <span className="validation-message">{errors.phone || ''}</span>
              </div>
              <div className={`input-group select-wrapper ${errors.gender ? 'invalid' : ''}`}>
                ...
                <span className="validation-message">{errors.gender || ''}</span>
              </div>
              <div className={`input-group ${errors.dateOfBirth ? 'invalid' : ''}`}>
                <i className="fas fa-calendar"></i>
                <input type="date" name="dateOfBirth" value={signUpData.dateOfBirth} onChange={handleSignUpChange} />
                <span className="validation-message">{errors.dateOfBirth || ''}</span>
              </div>
              <div className={`input-group select-wrapper ${errors.role ? 'invalid' : ''}`}>
                ...
                <span className="validation-message">{errors.role || ''}</span>
              </div>
            ...
            <div className={`form-step ${currentStep === 2 ? 'active' : ''}`}>
              ...
              <div className={`input-group ${errors.address ? 'invalid' : ''}`}>
                ...
                <input type="text" name="address" placeholder="Enter your full address" value={signUpData.address} onChange={handleSignUpChange} />
                <span className="validation-message">{errors.address || ''}</span>
              </div>
              <div className={`input-group ${errors.city ? 'invalid' : ''}`}>
                ...
                <span className="validation-message">{errors.city || ''}</span>
              </div>
              <div className={`input-group ${errors.zipCode ? 'invalid' : ''}`}>
              ...
              <div className={`input-group ${errors.password ? 'invalid' : ''}`}>
                ...
                ></i>
                <span className="validation-message">{errors.password || ''}</span>
              </div>
              <div className={`input-group ${errors.confirmPassword ? 'invalid' : ''}`}>
                ...
                ></i>
                <span className="validation-message">{errors.confirmPassword || ''}</span>
              </div>
              <div className="button-row">
        ...
        <div className="form-container sign-in-container">
          <form onSubmit={handleSignInSubmit}>
            ...
            <div className={`input-group ${errors.email ? 'invalid' : ''}`}>
              <i className="fas fa-envelope"></i>
              <input type="email" name="email" placeholder="Email Address" value={signInData.email} onChange={handleSignInChange} />
              <span className="validation-message">{errors.email || ''}</span>
            </div>
            <div className={`input-group ${errors.password ? 'invalid' : ''}`}>
              <i className="fas fa-lock"></i>
